...
class workflow_format_V21:
    ...
    def change_group(self,group):
        ...
        for g in group:
            ...
            try:
                funcname = g["outputname"]
            except:
                funcname = None
            try:
                functype = g["outputtype"]
            except:
                functype = None
            try:
            ...
            if methodname is not None and methodtype is not None:
                dic1 = [( 'methodname',methodname), ('methodtype',methodtype)] 
                dic.update(dic1)
            if methodname is not None and methodtype is None:
                dic1 = [( 'methodname',methodname) ] 
                dic.update(dic1)

            if funcname is not None and functype is not None:
                dic1 = [( 'funcname',funcname), ('functype',functype)]  
                dic.update(dic1)
            if funcname is not None and functype is None:
                dic1 = [('funcname',funcname)]  
                dic.update(dic1)
            groups.append(OrderedDict(dic))
        return groups
    ...
    def convert(self,data):
       ...
       wf = {"workflow":OrderedDict({"format":"v2.1", "block":wflist})}
       return wf


class workflow_format_V23:
    ...
    def convert(self,data):
       ...
       for x in block["block"]:
           ...
           workflowpart = OrderedDict({"blockname":wfname,"order":"workflow", "list":glist })
           wflist.append(workflowpart)

       wf = {"workflow":OrderedDict({"format":"v2.3", "block":wflist})}
       return wf
